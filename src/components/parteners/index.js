  ...
  <div className="container pt-0 pb-0">
    <div className="section-title text-center">
      <div className="row">
        <div className="col-md-10 col-md-offset-1">
          <h2 className="text-uppercase line-bottom-center mt-0">{t('Our')} <span className="text-theme-colored font-weight-600">{t('Parteners')}</span></h2>
    ...
    */} 
    ...
    >
          ...
          <div className="item"> <a href="#"> <img src={"http://placehold.it/200x120"} /></a></div>
          <div className="item"> <a href="#"> <img src={"http://placehold.it/200x120"} /></a></div>
          <div className="item"> <a href="#"><img src="http://placehold.it/200x120" alt /></a></div>
          <div className="item"> <a href="#"><img src="http://placehold.it/200x120" alt /></a></div>
          <div className="item"> <a href="#"><img src="http://placehold.it/200x120" alt /></a></div>
          <div className="item"> <a href="#"><img src="http://placehold.it/200x120" alt /></a></div>
          <div className="item"> <a href="#"><img src="http://placehold.it/200x120" alt /></a></div>
