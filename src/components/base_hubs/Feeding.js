...
<div className="container">
                          ...
                          <div class="causes-details col-md-6">
                                ...
                                <h2 class="line-bottom mt-0">{Feeding.name}</h2>
                                  ...
                                  <ul class="list-inline clearfix mt-10">
                                    <li class="text-theme-colored pull-left flip pr-0 font-weight-700 font-14"> {t("Total Donation")}:  <span> {Feeding.total_donation} SDG</span></li>
   ...
   <br />
        ...
        <div className="row multi-row-clearfix">
          ...
          <h3 class="mt-0 line-bottom">{t('Feeding Sub Sectors')}</h3>
          <br/>
