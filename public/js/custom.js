  ...
  THEMEMASCOT.header = {
    init: function () {
      var t = setTimeout(function () {
        ...
        THEMEMASCOT.header.TM_menuLogoOnSM();
    ...
    TM_menuLogoOnSM: function () {
      $document.on("click", ".menuzord-responsive menuzord-logo", function (e) {
        $(".menuzord-sm-logo").trigger("click");
        return true;
      });
    },
    // TM_menuCollapseOnClick: function() {
